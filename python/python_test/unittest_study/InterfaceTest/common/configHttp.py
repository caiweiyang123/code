...
if __name__ == '__main__':
    ...
    result1 = RunMain().run_main("post", "http://192.168.31.88:8888/login", {"name": "caiweiyang", "pwd": "123456"})
    result2 = RunMain().run_main("get", "http://192.168.31.88:8888/login", "name=caiweiyang&pwd=123456")
    print(result1)
    print(result2)
